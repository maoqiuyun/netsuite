  ...
  module Records
    class Invoice
      ...
      fields :balance,
        ...
        :exp_cost_disc_taxable, :exp_cost_discount, :exp_cost_list, :exp_cost_tax_rate_1,
        :exp_cost_tax_rate_2, :fax, :fob, :gift_cert_redemption_list, :handling_tax_1_rate,
        :handling_tax_2_rate, :is_taxable, :item_cost_disc_amount, :item_cost_disc_print,
        :item_cost_disc_rate, :item_cost_disc_tax_1_amt, :item_cost_disc_taxable, :item_cost_discount, :item_cost_list,
        :item_cost_tax_rate_1, :item_cost_tax_rate_2, :last_modified_date,
        ...
        :time_discount, :time_list, :time_tax_rate_1, :time_tax_rate_2, :to_be_emailed, :to_be_faxed,
      ...
      record_refs :account, :bill_address_list, :custom_form, :department, :entity, :klass, :partner,
                  ...
                  :ship_method, :lead_source, :promo_code, :subsidiary, :currency, :approval_status, :job, :discount_item, :shipping_tax_code,
                  :exp_cost_tax_code, :handling_tax_code, :item_cost_tax_code, :time_tax_code
